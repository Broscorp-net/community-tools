...
public class Messages {
  ...
  public static final String EMAIL =  "<pre>Добрый день! Мы готовы начать нашу стажировку.\n" +
          ...
          "Ура, Вас поприветствует Bro_Bot - создан для того, чтобы помочь Вам пройти первый этап нашей стажировки.\n" +
          "Внимательно ознакомьтесь с инструкцией для выполнения заданий. После прочтения инструкции\n" +
          "дайте ответ на несколько вопросов, которые задаст наш Bro_Bot. Следуйте дальнейшим указаниям нашего Bro!\n" +
          "Наш друг будет присылать линки на следующую таску после выполнения предыдущей задачки (после пулл реквеста).\n" +
          "Пожалуйста, выполняйте задачки исключительно в порядке выдачи тасок! \n" +
          "Если вдруг Bro не выдает Вам задачу или у Вас появились какие-то вопросы - напишите мне на почту \n" +
